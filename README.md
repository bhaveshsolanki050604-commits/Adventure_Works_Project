...
Order vs return comparison
Category-wise revenue insights

📌 Insight: Bikes contribute the majority of revenue, with steady growth despite minor mid-year fluctuations.

2️⃣ Reverse Flow Insights (Returns Analysis)

Focuses on return behavior and product performance:

Total returns: 1,828 units
Category-wise return contribution
Monthly return trends
Return rate comparison

📌 Insight: Accessories contribute 61.82% of returns, while Bikes show a higher return rate (3.08%), indicating potential quality or expectation gaps.

3️⃣ Market Landscape

Explores geographic and customer-level insights:

Revenue distribution across countries
Market concentration using treemap & map
...
Interact using slicers (Month, Category, etc.)
Explore insights across all 3 pages
